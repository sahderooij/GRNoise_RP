...
timeshiftcorr=-1i*2*pi*f.*t(1); %fft function doesn't take time into account, it assumes for n=1 t=0. So fft properties like x=real,even ->X=real,even are lost
